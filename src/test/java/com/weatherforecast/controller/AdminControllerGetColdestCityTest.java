...
class AdminControllerGetColdestCityTest {
    @Autowired
    ...
    void findColdestCityIfAdminAndIfDatabaseNotEmpty() throws Exception {
        ...
        mockMvc.perform(get("/api/admin/coldest"))
    ...
    void findColdestCityIfUser() throws Exception {
        mockMvc.perform(get("/api/admin/coldest"))
    ...
    @Test
    @WithMockUser(username = "user1@company.com", roles = "ADMIN")
    void findColdestCityIfAdminAndIfDataBaseIsEmpty() throws Exception {
        mockMvc.perform(get("/api/admin/coldest"))
